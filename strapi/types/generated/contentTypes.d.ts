...
export interface ApiHotelHotel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    areaId: Schema.Attribute.Integer;
    chainId: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    chainName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    cityId: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dbName: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
    instance: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    status: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    step: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiRoomTypeRoomType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bedCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    maxCheckInCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<2>;
    publishedAt: Schema.Attribute.DateTime;
    rooms: Schema.Attribute.Relation<'oneToMany', 'api::room.room'>;
    roomTypeCode: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 20;
      }>;
    roomTypeName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
...
export interface ApiRoomRoom extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::room.room'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    roomNo: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 20;
      }>;
    roomType: Schema.Attribute.Relation<
      'manyToOne',
      'api::room-type.room-type'
    >;
    updatedAt: Schema.Attribute.DateTime;
